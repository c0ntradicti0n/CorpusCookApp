...
def science_video():
    ...
    if request.method == 'GET':
        ...
        cmd = "ffmpeg -y -i record.mp4 -acodec libfaac -ab 96k -vcodec libx264 -vpre slower -vpre main -level 21 -refs 2 -b 345k -bt 345k -threads 0 -s 700x700 record_compressed.mp4  ;" + \
